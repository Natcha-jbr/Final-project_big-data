# Project Title : What Makes a Game Perform?
# Project Description
...
If only expensive games do well, what does that say about how fair and accessible gaming really is ?
...
# File Structure
| Data set              | Key field                                     | Size       |
|-----------------------|-----------------------------------------------|------------|
| game2.json            | Game ID, price, supported languages, tags     | 97,410 games |
| review.csv            | Game ID, review score, positive/negative counts | 140,154     |
| streamspy_insight.csv | Game ID, concurrent users                     | 140,077     |
...
- R-squared: 0.055, only about 5.5% of the variation in user reception is explained by price, violence, and languages.

### Player Engagement:
- Player engagement: log_concurrent_users_yesterday = -0.4430 + 0.8246 × log_price + 0.1204 × violence_score + 0.0888 × no_sup_lang
- R-squared: 0.213, about 21.3% of the variation in player engagement is explained by price, violence, and languages.
...
# Contributors
- 110702019 Wang Li Ting 王俐婷
- 111ZU1023 Edric Kee Hong Zhao 紀宏釗
- 111ZU1039 Natcha Jaibumrung 黃文晶
